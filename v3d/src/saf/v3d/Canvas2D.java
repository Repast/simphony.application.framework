...
//    }
	...
	/**
	 * Sets the default extent of the objects displayed by this canvas. If these are
	 * non-zero then these values will be used to scale the display such that it
	 * will fit in the canvas.
	 * 
	 * @param width
	 * @param height
	 */
	...
	/**
	 * Gets the lock that can be used to synchronize on the rendering. This lock is
	 * locked while rendering occurs and then unlocked when rendering is finished.
	 * 
	...
	public void setSize(int width, int height) {
		((GLJPanel)drawable).setSize(width, height);
	}
	 ...
	 * 
	 * @return a Box representing the dimensions of the viewable world when z is 0.
	 * 
